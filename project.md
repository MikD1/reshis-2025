...
Эти инструкции помогут тебе скопировать код проекта на твой компьютер и запустить его.

# Как скачать (склонировать) репозиторий с GitHub

Чтобы начать работать с проектом локально, тебе нужно склонировать свой репозиторий — то есть скачать его на компьютер. Для этого необходимо установить [Git](https://git-scm.com/install/), либо воспользоваться встроенным клиентом Git в твоей IDE.

Если ты никогда раньше не работал с проектами на Python, можно скачать и настроить [IDE VS Code](https://code.visualstudio.com/docs/python/python-tutorial).
